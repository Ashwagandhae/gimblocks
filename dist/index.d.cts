...
type CustomConvertExpression = (expression: Expression, ctx: Context, convertExpression: (expression: Expression) => Block | Placeholder) => Block | Placeholder;
type Context = {
    device: string;
    level: number;
...
declare function countProgramBlocks(program: Program): number;
declare function countBlocks(block: Block): number;
