...
pp$8.parseClass = function(node, isStatement2) {
  this.next();
  var oldStrict = this.strict;
  this.strict = true;
  this.parseClassId(node, isStatement2);
...
pp$8.parseClassId = function(node, isStatement2) {
...
function flattenIfStatement(statement) {
  const ret = [];
  let current2 = statement;
  while (current2?.type == "IfStatement") {
    ret.push(current2);
