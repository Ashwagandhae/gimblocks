 ...
 */
type LiteralNumber<T extends number> = number extends T ? never : NotUnion<T>;
/**
 ...
 * 'rgb(255, 0, 0)'
 */
type Color<T extends string> = LiteralString<T>;
...
type Union = {
     ...
     */
    logicCompare: <T extends "EQ" | "NEQ" | "LT" | "LTE" | "GT" | "GTE">(A: any, OP: LiteralString<T>, B: any) => boolean;
    /**
     ...
     */
    logicOperation: <T extends "AND" | "OR">(A: boolean, OP: LiteralString<T>, B: boolean) => boolean;
    /**
     ...
     */
    mathArithmetic: <T extends "ADD" | "MINUS" | "MULTIPLY" | "DIVIDE" | "POWER">(A: number, OP: LiteralString<T>, B: number) => number;
    /**
     ...
     */
    mathSingle: <T extends "ROOT" | "ABS" | "NEG" | "LN" | "LOG10" | "EXP" | "POW10">(OP: LiteralString<T>, NUM: number) => number;
    /**
     ...
     * @param NUM - An input block of type `number`.
     */
    mathTrig: <T extends "SIN" | "COS" | "TAN" | "ASIN" | "ACOS" | "ATAN">(OP: LiteralString<T>, NUM: number) => number;
    /**
     ...
     */
    mathConstant: <T extends "PI" | "E" | "GOLDEN_RATIO" | "SQRT2" | "SQRT1_2" | "INFINITY">(CONSTANT: LiteralString<T>) => number;
    /**
     ...
     */
    mathNumberProperty: <T extends "EVEN" | "ODD" | "PRIME" | "WHOLE" | "POSITIVE" | "NEGATIVE" | "DIVISIBLE_BY">(NUMBER_TO_CHECK: number, PROPERTY: LiteralString<T>) => boolean;
    /**
     ...
     * @param NUM - An input block of type `number`.
     */
    mathRound: <T extends "ROUND" | "ROUNDUP" | "ROUNDDOWN">(OP: LiteralString<T>, NUM: number) => number;
    /**
     ...
     */
    inText: <T extends "FIRST" | "LAST">(VALUE: string, END: LiteralString<T>, FIND: string) => number;
    /**
